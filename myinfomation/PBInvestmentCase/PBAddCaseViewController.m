...
#define ADD_CASE_URL [NSString stringWithFormat:@"%@admin/index/addinverstorproject",HOST]

@implementation PBAddCaseViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        addAnli = [[PBAddAnLiData alloc]init];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if([iCVC.tradeArr count]>0){
      self.label1.text = [iCVC.tradeArr objectForKey:@"name"];
    }
    self.label1.text = iCVC.hangyeStr;
...
-(void)finish
{
    ...
    NSString* tradeName = [[nodesMutableArr objectAtIndex:1] objectForKey:@"trade"];
    ...
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithObjectsAndKeys:nameLabel.text?nameLabel.text:@"", @"name", tradeId,@"trade",label4.text?label4.text:@"",@"projectstage",labeljieshao.text?labeljieshao.text:@"",@"projectintroduce",projectstage,@"projectstage",textField2.text?textField2.text:@"",@"starttime",rongziLabel.text?rongziLabel.text:@"",@"money",[NSString stringWithFormat:@"%d",[PBKbnMasterModel getKbnIdByName:label2.text?label2.text:@"" withKind:@"unit"]],@"moneyunit",spVC.str,@"ycno",spVC.projectinfonoStr,@"projectinfono",nil];
    [parkManager submitDataFromUrl:ADD_CASE_URL postValuesAndKeys:dic];
    
}

-(void)sucessSendPostData:(NSObject *)Data{
    [PBAddAnLiData replaceKeyValue:addAnli.no withNo:parkManager.keyValue];
...
-(void)textFieldAndLabel
{
    ...
    if (isPad()) {
        ...
        textField2 = [[UITextField alloc] initWithFrame:CGRectMake(140, 12, 550, 24)];
        rongziLabel = [[UILabel alloc] initWithFrame:CGRectMake(140, 12, 550, 24)];
        label1 = [[UILabel alloc] initWithFrame:CGRectMake(130, 10, 570, 25)];
        label2 = [[UILabel alloc] initWithFrame:CGRectMake(130, 10, 570, 25)];
        label4 = [[UILabel alloc] initWithFrame:CGRectMake(130, 10, 570, 25)];
        projectLabel = [[UILabel alloc] initWithFrame:CGRectMake(140, 12, 550, 24)];
        
    }else{
        nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(135, 12, 150, 24)];
        textField2 = [[UITextField alloc] initWithFrame:CGRectMake(100, 12, 180, 24)];
        rongziLabel = [[UILabel alloc] initWithFrame:CGRectMake(100, 12, 180, 24)];
        label1 = [[UILabel alloc] initWithFrame:CGRectMake(150, 10, 130, 25)];
        label2 = [[UILabel alloc] initWithFrame:CGRectMake(150, 10, 130, 25)];
        label4 = [[UILabel alloc] initWithFrame:CGRectMake(150, 10, 130, 25)];
        projectLabel = [[UILabel alloc] initWithFrame:CGRectMake(100, 12, 180, 24)];
    }
...
-(void)saveData
{
    ...
    addAnli.no = [PBAddAnLiData SaveId:addAnli.no name:nameLabel.text trade:trade projectintroduce:labeljieshao.text projectstage:projectstage starttime:textField2.text money:[rongziLabel.text intValue] moneyunit:[PBKbnMasterModel getKbnIdByName:label2.text withKind:@"unit"] ycno:[spVC.str intValue] projectinfono:[spVC.projectinfonoStr intValue]];
}
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    self.title = @"添加案例";
     indicator = [[PBActivityIndicatorView alloc]initWithFrame:isPad()?CGRectMake(0, 0, 768, 1024) : CGRectMake(0, 0, 320, 480-KTabBarHeight-KNavigationBarHeight)];
    ...
    if (isPad()) {
        self.datepicker = [[[UIDatePicker alloc]initWithFrame:CGRectMake(0, 200, 768, 450)]autorelease];
    }else{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        labeljieshao.text = edit2VC.popStr;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        ...
        edit2VC.popStr=labeljieshao.text;
        edit2VC.title = @"项目概要";
