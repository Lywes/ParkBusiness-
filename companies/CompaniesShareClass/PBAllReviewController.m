...
#define kREMARKURLSTRING [NSString stringWithFormat:@"%@admin/index/searchremarkdynamic", HOST]

@interface PBAllReviewController ()

@end

static CGFloat labelHeight = 21.0;
@implementation PBAllReviewController
@synthesize userNoString;
@synthesize manager;
...
- (void) requestData:(NSString *)pageno
{
    ...
    [manager requestBackgroundXMLData:kREMARKURLSTRING forValueAndKey:dic];
}
