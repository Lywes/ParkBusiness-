...
@interface PBNewestEntrepreneurs ()

@end

@implementation PBNewestEntrepreneurs
@synthesize manager;
...
- (void) requestData:(NSString *)pageno
{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:pageno, @"pageno",USERNO, @"no", @"2", @"kind", @"1", @"date",[NSString stringWithFormat:@"%d",[PBUserModel getParkNo]],@"parkno", nil];
