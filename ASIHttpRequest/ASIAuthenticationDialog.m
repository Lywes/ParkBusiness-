...
- (void)show
{
	...
	[navItem setRightBarButtonItem:[[[UIBarButtonItem alloc] initWithTitle:@"Login" style:UIBarButtonItemStylePlain target:self action:@selector(loginWithCredentialsFromDialog:)] autorelease]];
