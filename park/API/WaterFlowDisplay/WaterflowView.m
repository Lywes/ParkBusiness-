...
@synthesize cellHeight=_cellHeight,visibleCells=_visibleCells,reusableCells=_reusedCells,cellIndex;
...
{    
    ...
    for (int i = 0; i< [self.flowdatasource numberOfData] ; i++)
    {        
        //the first pics
...
- (void)pageScroll
{
    //CGPoint offset = self.contentOffset;
        ...
        //此地方有改动
    for (int i = 0 ; i< numberOfColumns&&[self.flowdatasource numberOfData]>0; i++)
    {
