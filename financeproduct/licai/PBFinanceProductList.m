...
@interface PBFinanceProductList ()

@end

@implementation PBFinanceProductList
...
-(void)getXmlData:(NSString*)page{
    ...
    NSArray* arr1 = [NSArray arrayWithObjects:page,self.recommend,[NSString stringWithFormat:@"%d",[PBUserModel getCompanyno]], nil];
    NSArray* arr2 = [NSArray arrayWithObjects:@"pageno",@"flag", @"companyno",nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([weiboData.parseData count]>0){
        ...
        cell.productimage = [[CustomImageView alloc]initWithFrame:isPad()?CGRectMake(15, 5, 200 , 100):CGRectMake(5, 6, 110 , 75) withBackColor:[UIColor whiteColor]];
...
-(void)pushDetailController:(NSIndexPath*)indexPath{
    ...
    detailViewController.title = @"团购产品详细信息";
