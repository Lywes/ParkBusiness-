...
@interface PBSpecificTradeController ()
@end

@implementation PBSpecificTradeController
@synthesize manager;
@synthesize tradeString;
@synthesize dataArray;
@synthesize pullController;
@synthesize send;
@synthesize tradeTitleString;
...
- (void)viewDidLoad
{
    ...
    self.title = tradeTitleString?tradeTitleString:@"最新项目";
...
- (void) requestData:(NSString *)pageno
{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:pageno, @"pageno", tradeString, @"trade",USERNO,@"userno", nil];
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil) {
        ...
        cell.projectImageView = [[CustomImageView alloc] initWithFrame:CGRectMake(3, 3, 48, 48)];
    }
...
- (void)viewDidUnload {
    [self setTradeTitleString:nil];
    [self setSend:nil];
    [self setPullController:nil];
    [self setDataArray:nil];
    [self setManager:nil];
    [self setTradeString:nil];
    [super viewDidUnload];
}
@end
