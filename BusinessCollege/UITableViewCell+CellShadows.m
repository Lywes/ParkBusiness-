                       ...
                       atIndexPath:(NSIndexPath *)indexPath
{
  ...
  if(isFirstRow)
    ...
    shadowRect.size.height -= 0;
  
  // the mask rect ensures that the shadow doesn't bleed into other table cells
  CGRect maskRect = CGRectInset(self.backgroundView.bounds, 0, 0);
  if(isFirstRow) {
  ...
  layer.shadowPath = [UIBezierPath bezierPathWithRoundedRect:shadowRect cornerRadius:10].CGPath;
